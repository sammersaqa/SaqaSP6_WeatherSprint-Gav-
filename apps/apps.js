...
/**
 * Handles the search input and loads weather for the entered city
 */
...
/**
 * Loads current weather and forecast data for a city
 * @param {string} city - City name to load weather for
 */
